...
use strict;
use warnings;
open (MYFILE1,'>>NPMI0.1_ocu2.txt');
open (MYFILE2,'>>NPMI0.2_ocu2.txt');
open (MYFILE3,'>>NPMI0.3_ocu2.txt');
open (MYFILE4,'>>NPMI0.4_ocu2.txt');
open (MYFILE5,'>>NPMI0.5_ocu2.txt');
open (MYFILE6,'>>NPMI0.6_ocu2.txt');
open (MYFILE7,'>>NPMI0.7_ocu2.txt');
open (MYFILE8,'>>NPMI0.8_ocu2.txt');
