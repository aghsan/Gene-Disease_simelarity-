...
%FN=();
%pairNew2=();
open IN, "expandedRANK1_ocu2.txt" or die "cannot open the ontology file";
...
open IN, "expandedRANK2_ocu2.txt" or die "cannot open the ontology file";
...
open IN, "expandedRANK4_ocu2.txt" or die "cannot open the ontology file";
...
open IN, "expandedRANK6_ocu2.txt" or die "cannot open the ontology file";
...
open IN, "expandedRANK8_ocu2.txt" or die "cannot open the ontology file";
...
open IN, "expandedRANK10_ocu2.txt" or die "cannot open the ontology file";
...
open IN, "expandedRANK12_ocu2.txt" or die "cannot open the ontology file";
...
open IN, "expandedRANK14_ocu2.txt" or die "cannot open the ontology file";
