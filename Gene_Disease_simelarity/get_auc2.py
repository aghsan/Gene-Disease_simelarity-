...
sim_scores = np.loadtxt('/home/alahas0a/Documents/DRwork/semanticsemalarity/output/semanticResult_rank78_fromHPO.txt', dtype = 'float32')
pathogens = np.genfromtxt('Diseases_HPO_uniqe.txt', dtype = 'str')
proteins = np.genfromtxt('uniprotID_rank78_uniqe_HPO.txt', dtype = 'str')


pathogens_proteins = {}
with open('restrictedOMIM_Data_Unique_Pairs.txt') as f:
	for line in f:
...
plt.savefig('auc_rank78_new_HPO.png')
